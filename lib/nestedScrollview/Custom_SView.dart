      ...
      body: SafeArea(
        ...
        headerSliverBuilder: ((context, innerBoxIsScrolled) => [
              SliverAppBar(
                ...
                // flexibleSpace: //greater Container
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              '\$ ',
                              style:
                                  TextStyle(fontFamily: 'Mulish', fontSize: 19),
                            ),
                            Text(
                              '25,685',
                              style: TextStyle(
                            ...
                            Text(
                              ' .55',
                              style:
                                  TextStyle(fontFamily: 'Mulish', fontSize: 15),
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            ...
                            Text(
                              'ADD MONEY',
                              style:
                                  TextStyle(fontFamily: 'Barlow', fontSize: 11),
                            )
                          ]),
                        ),
                      ),

                      //ListView horizontally
                      Positioned(
                        bottom: 30,
                        child: SizedBox(
                          height: 120,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                '7:40pm',
                                style: TextStyle(
                                    color: Color.fromARGB(255, 165, 171, 168)),
                              )
                            ],
                          ),
                          Spacer(),
